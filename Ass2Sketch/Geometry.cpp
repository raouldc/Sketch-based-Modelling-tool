...
// distance of point to a line given by start and end point
// Efficient formula derived in http://mathworld.wolfram.com/Point-LineDistance3-Dimensional.html
float CVec3df::distanceToLine(const CVec3df& start, const CVec3df& end)
{
	CVec3df diff1=(*this)-start;
	CVec3df diff2=(*this)-end;
	CVec3df n=diff1.cross(diff2);
	CVec3df diff3=end-start;
	return n.length()/diff3.length();
}
